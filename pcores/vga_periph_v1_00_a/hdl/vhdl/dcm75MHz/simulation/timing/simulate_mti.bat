...
vlog -work work dcm75MHz_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax dcm75MHz_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.dcm75MHz_tb work.glbl
